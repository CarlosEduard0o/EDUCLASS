package br.com.educlass.view.adm.teacher.editTeacher.teacherEditConfirmation;
...
public class TeacherEditConfirmation implements Initializable {
    @FXML
    ...
    private void setLanguage(
        ...
        HashMap<String, String> texts = Language
                .getTexts("src/main/resources/br/com/educlass/view/adm/teacher/editTeacher/teacherEditConfirmation/languages/");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Teacher teacher = AdmnistratorService.getEditTeacher();
